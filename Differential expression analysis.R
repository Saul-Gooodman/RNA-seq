...
# Extract results for a pairwise comparison (e.g., comparing "Lung_WT_Case" vs. "Lung_WT_Control")
...
# Extract normalized expression data for genes of interest (e.g., Gbp2, Fcer1g, Tgfp1)
